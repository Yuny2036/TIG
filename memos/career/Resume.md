...
## 면접 🤝
"면접은 채용해야 할 이유를 찾는 자리이다."

### 구조화 면접
- 개인이 가지고 있는 경험에 대한 질문을 하는 형태. 즉, 지원자가 행동하는 것에 대해서 실제 한 경험이 맞는지 검증하는 것

|스타일|특징|비고|
|---:|:---|:---|
|경험면접|과거의 직무관련 경험|꼬리에 꼬리를 무는 압박면접도 이 쪽에 있음|
|상황면접|특정상황을 제시하고 행동을 예측|-|
|발표면접|발표나 질의를 통한 역량평가|-|
|토론면접|지원자 역량이나 상호작용 능력을 평가|-|

### 면접 전 꼭 해야 할 일
1. 직무역량 검증이 제일 중요
  - 내가 지원하는 업태, 업종, 직군, 세부직무를 제대로 알고 있는가
  - 관련 유사 경험이 있는가 (아르바이트, 계약직, 인턴 등)
  - 유사 경험을 하며 성과를 낸 적이 있는가
  - 유사 경험을 하며 지원자에게 적합하다고 느꼈는가
  - 지원 직무에서 보다 더 성과를 내려면 무엇이 필요한 지 아는가
2. 면접 예상질문을 어느정도 준비해두기
  - 자기소개 \| 전공 \| 직무 \| 회사 에 맞춰 미리 작성해 준비해보기
